...
sub graphs { return {
    caches => {
        ...
        data_sources => [
            {name => 'Key_reads',             graph  => 'no', type  => 'DERIVE'},
            {name => 'krd',                   graph  => 'no'},
            {name => 'Key_read_requests',     graph  => 'no', type  => 'DERIVE'},
            {name => 'krrd',                  graph  => 'no'},
            {name => 'key_cache_eff',         label  => 'Momentary key cache efficiency',
                                              update => 'no',
                                              # this should check for krrd==0
                                              cdef   => '1,krd,krrd,/,-,100,*'},
            {name => 'Qcache_hits',           graph  => 'no', type  => 'DERIVE'},
            {name => 'qh',                    graph  => 'no' },
            {name => 'Com_select',            graph  => 'no', type  => 'DERIVE'},
            {name => 'cs',                    graph  => 'no' },
            ...
            {name => 'Binlog_cache_disk_use', graph  => 'no', type  => 'DERIVE'},
            {name => 'bcdu',                  graph  => 'no'},
            {name => 'Binlog_cache_use',      graph  => 'no', type  => 'DERIVE'},
            {name => 'bcu',                   graph  => 'no'},
